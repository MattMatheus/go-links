...
class TestFunctions(TrottoTestCase):
    ...
    def test__get_link_key__go_namespace(self):
        self.assertEqual(
            "b'Z29vZ3MuY29t':roadmap", links._get_link_key("googs.com", "go", "roadmap")
        )

    def test__get_link_key__no_namespace(self):
        self.assertEqual(
            "b'Z29vZ3MuY29t':roadmap", links._get_link_key("googs.com", None, "roadmap")
        )

    def test__get_link_key__other_namespace(self):
        self.assertEqual(
            "b'Z29vZ3MuY29t':eng:roadmap", links._get_link_key("googs.com", "eng", "roadmap")
        )

    def test__get_link_key__complex_path(self):
        self.assertEqual(
            "b'Z29vZ3MuY29t':eng:roadmap/q2", links._get_link_key("googs.com", "eng", "roadmap/q2")
        )
    ...
    def test_put__ns_column_explicitly_set_to_alternative_default_namespace(
        self, mock_get_default_namespace
    ):
        links.ShortLink(
            created=datetime.datetime(2018, 10, 1),
            organization="googs.com",
    ...
    def test_put__other_namespace(self):
        ...
        self.assertEqual(["eng"], [l._ns for l in links.ShortLink._get_all()])
    ...
    def test_get_by_id__go_namespace(self):
        ...
        self.assertEqual("b'Z29vZ3MuY29t':1", go_link.key)
        self.assertEqual("go", go_link.namespace)

    def test_get_by_id__other_namespace(self):
        eng_link = self._add_link("eng", "2")
        eng_link = links.ShortLink.get_by_id(eng_link.get_id())

        self.assertEqual("b'Z29vZ3MuY29t':eng:2", eng_link.key)
        self.assertEqual("eng", eng_link.namespace)
    ...
    def test_get_by_full_path__go_namespace(self):
        ...
        self.assertEqual("go", queried_link.namespace)
    ...
    def test_get_by_full_path__other_namespace(self):
        ...
        self.assertEqual(googs_link, queried_link)
        self.assertEqual("eng", queried_link.namespace)
    ...
    def test_get_by_organization(self):
        ...
        self.assertEqual(["go", "eng"], [l.namespace for l in googs_links])
